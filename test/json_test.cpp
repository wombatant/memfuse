...
int typeMismatchTest() {
	string good = "{\"field2\":42}";
	string bad = "{\"field2\":{}}";
	string testLbl = "JSON type mismatch detection:";
	return test(good, bad, testLbl, TypeMismatch);
}

int missingFieldTest() {
	string good = "{\"field1\":true,\"field2\":42,\"field3\":0,\"field4\":\"\",\"field5\":[],\"field6\":{\"field1\":42},\"field7\":{}}";
	string bad = "{\"field1\":true}";
	string testLbl = "JSON missing field detection:";
	return test(good, bad, testLbl, MissingField);
}
